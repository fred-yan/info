...
urlpatterns = [
    ...
    path("wscn/", views.wscn_view),
    path("cls/", views.cls_view),
    path("jiqizhixin/", views.jiqizhixin_view),
    path("tmtpost/", views.tmtpost_view),
    path("theverge/", views.theverge_view),
    path("techcrunch/", views.techcrunch_view),
    path("mittr/", views.mittr_view),
    ...
    path("llm/extract/", frontend_views.llm_extract_platform_view),
]
